...
CREATE OR REPLACE VIEW "public"."SpeciesStats" WITH ("security_invoker"='true') AS
 SELECT "sp"."species_name",
    ...
    "percentile_cont"((0.5)::double precision) WITHIN GROUP (ORDER BY (("e"."weight")::double precision)) AS "median_weight",
    "max"("e"."wing_length") AS "max_wing",
    "round"("avg"("e"."wing_length"), 1) AS "avg_wing",
    "min"("e"."wing_length") AS "min_wing",
    "percentile_cont"((0.5)::double precision) WITHIN GROUP (ORDER BY (("e"."wing_length")::double precision)) AS "median_wing",
...
GRANT ALL ON TABLE "public"."SpeciesStats" TO "anon";
GRANT ALL ON TABLE "public"."SpeciesStats" TO "authenticated";
GRANT ALL ON TABLE "public"."SpeciesStats" TO "service_role";
